...
const paths = {
    ...
    src: {
        ...
        favicon: 'resources/_assets/favicon/*',
        fonts: 'resources/_assets/fonts/*',
        js: {
...
gulp.task('default', ['clean:build'], () => {
    return gulp.start('compile:sass', 'build:img', 'build:svg', 'build:favicon', 'build:fonts', 'build:js', 'build:jekyll')
})
